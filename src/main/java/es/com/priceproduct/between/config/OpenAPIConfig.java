package es.com.priceproduct.between.config;
...
public class OpenAPIConfig {
  ...
  public OpenAPI myOpenAPI() {
    ...
    devServer.setDescription("Server URL in Development environment for Test for Between");
    ...
    Info info = new Info()
        .title("Price of Products API for TEST for Between")
        .version("1.0.0")
        .contact(contact)
